...
public class TS_Reset_Functionality_EmployeeList {
	...
	public void Test()
		...
		oPSelFW = new ProlificsSeleniumAPI("PIM Tab", "Reset functionality in EmployeeList in OrangeHRM Application", "Chrome", "Windows 10",
	...
	private static Object[][] asTwoDimensionalArray() throws FileNotFoundException, IOException {
		...
		for (int j = 1; j <= RowCount; j++) {
			XLTestData = excelReader.readExcel("TS_Reset_Functionality_inEmployeeList_" + Integer.toString(j));
	...
	public void orderSearchWCC(HashMap<String, String> XLTestData) throws Exception {
		try {
			...
			objOrangeHRM.resetEmployee(driver, oPSelFW, XLTestData);
